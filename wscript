...
def build(bld):
    ...
    bld.program(
        ...
        source       = ['src/main.cxx',
                        ...
                        'src/Elastic/FAC/intersection/intersect_fault.cxx',
                        'src/Elastic/FAC/intersection/intersection.cxx',
                        'src/Elastic/FAC/compute_intersections_2D.cxx',
                        'src/Elastic/FAC/compute_intersections_3D.cxx',
                        ...
                        'src/Elastic/FAC/solve/setup_fault_corrections/compute_dv.cxx',
