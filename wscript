...
def build(bld):
    ...
    bld.program(
        ...
        source       = ['src/main.cxx',
                        ...
                        'src/Elastic/V_Boundary_Refine/V_Boundary_Refine.cxx',
                        'src/Elastic/V_Boundary_Refine/refine.cxx',
                        'src/Elastic/V_Boundary_Refine/Update_V_2D.cxx',
                        'src/Elastic/V_Boundary_Refine/Update_V_embedded_2D.cxx',
                        'src/Elastic/V_Boundary_Refine/Correction_2D.cxx',
                        'src/Elastic/V_Boundary_Refine/Update_V_3D.cxx',
                        ...
                        'src/Elastic/Boundary_Conditions/set_boundary.cxx',
                        ...
                        'src/Elastic/FACOps/computeVectorWeights.cxx',
                        ...
                        'src/Elastic/FACOps/smooth_2D.cxx',
                        'src/Elastic/FACOps/smooth_3D.cxx',
                        'src/Elastic/FACOps/set_boundaries.cxx',
                        'src/Elastic/FACOps/solveCoarsestLevel.cxx',
                        'src/Elastic/FACOps/smooth_V_2D.cxx',
                        'src/Elastic/FACOps/smooth_V_3D.cxx',
                        'src/Elastic/FACOps/xeqScheduleGhostFill.cxx',
                        'src/Elastic/FACOps/xeqScheduleGhostFillNoCoarse.cxx',
                        'src/Elastic/FACOps/xeqScheduleProlongation.cxx',
                        'src/Elastic/FACOps/xeqScheduleRRestriction.cxx',
                        'src/Elastic/FACOps/xeqScheduleURestriction.cxx',
                        ...
                        'src/Stokes/FACOps/computeVectorWeights.cxx',
                        ...
                        'src/Stokes/FACOps/set_boundaries.cxx',
                        ...
                        'src/Stokes/FACSolver/initializeStatics.cxx',
