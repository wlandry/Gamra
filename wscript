...
def build(bld):
    ...
    bld.program(
        ...
        source       = ['src/main.C',
                        ...
                        'src/Elastic/Boundary_Conditions/okada.C',
                        'src/Elastic/Boundary_Conditions/okada_tangent_deriv.C',
                        ...
                        'muparserx_v2_1_3/parser/mpError.cpp',
                        'muparserx_v2_1_3/parser/mpFuncCmplx.cpp',
                        'muparserx_v2_1_3/parser/mpFuncCommon.cpp',
                        'muparserx_v2_1_3/parser/mpFuncMatrix.cpp',
                        'muparserx_v2_1_3/parser/mpFuncNonCmplx.cpp',
                        'muparserx_v2_1_3/parser/mpFuncStr.cpp',
                        'muparserx_v2_1_3/parser/mpICallback.cpp',
                        'muparserx_v2_1_3/parser/mpIOprt.cpp',
                        'muparserx_v2_1_3/parser/mpIPackage.cpp',
                        'muparserx_v2_1_3/parser/mpIToken.cpp',
                        'muparserx_v2_1_3/parser/mpIValReader.cpp',
                        'muparserx_v2_1_3/parser/mpIValue.cpp',
                        'muparserx_v2_1_3/parser/mpIfThenElse.cpp',
                        'muparserx_v2_1_3/parser/mpOprtBinAssign.cpp',
                        'muparserx_v2_1_3/parser/mpOprtBinCommon.cpp',
                        'muparserx_v2_1_3/parser/mpOprtCmplx.cpp',
                        'muparserx_v2_1_3/parser/mpOprtIndex.cpp',
                        'muparserx_v2_1_3/parser/mpOprtMatrix.cpp',
                        'muparserx_v2_1_3/parser/mpOprtNonCmplx.cpp',
                        'muparserx_v2_1_3/parser/mpPackageCmplx.cpp',
                        'muparserx_v2_1_3/parser/mpPackageCommon.cpp',
                        'muparserx_v2_1_3/parser/mpPackageMatrix.cpp',
                        'muparserx_v2_1_3/parser/mpPackageNonCmplx.cpp',
                        'muparserx_v2_1_3/parser/mpPackageStr.cpp',
                        'muparserx_v2_1_3/parser/mpPackageUnit.cpp',
                        'muparserx_v2_1_3/parser/mpParser.cpp',
                        'muparserx_v2_1_3/parser/mpParserBase.cpp',
                        'muparserx_v2_1_3/parser/mpRPN.cpp',
                        'muparserx_v2_1_3/parser/mpScriptTokens.cpp',
                        'muparserx_v2_1_3/parser/mpTest.cpp',
                        'muparserx_v2_1_3/parser/mpTokenReader.cpp',
                        'muparserx_v2_1_3/parser/mpValReader.cpp',
                        'muparserx_v2_1_3/parser/mpValue.cpp',
