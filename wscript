...
def build(bld):
    ...
    bld.program(
        ...
        source       = ['src/main.cxx',
                        ...
                        'src/Elastic/FACOps/smoothError/smoothError.cxx',
                        'src/Elastic/FACOps/smoothError/Gauss_Seidel_red_black_2D.cxx',
                        'src/Elastic/FACOps/smoothError/Gauss_Seidel_red_black_3D.cxx',
