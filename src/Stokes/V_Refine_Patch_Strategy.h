...
namespace Stokes {
   ...
   * SAMRAI::xfer::RefinePatchStrategy so it may be used to help create
  ...
  public:
     ...
     */
    V_Refine_Patch_Strategy(std::string object_name = std::string()):
    ...
    virtual void
    setPhysicalBoundaryConditions(SAMRAI::hier::Patch& ,
                                  const double ,
    ...
    preprocessRefine(SAMRAI::hier::Patch& ,
                     ...
                     const SAMRAI::hier::IntVector& )
    {
      Stokes_set_boundary(coarse,invalid_id,v_id,true);
    }
