...
namespace Stokes {
  ...
  public:
     ...
     * @param database SAMRAI::tbox::Database for input.
     */
    HypreSolver(
                const SAMRAI::tbox::Dimension& dim,
                const std::string& object_name,
                boost::shared_ptr<SAMRAI::tbox::Database> database =
                boost::shared_ptr<SAMRAI::tbox::Database>(NULL));
     ...
     * @param variable SAMRAI::hier::Variable pointer to be passed
    ...
    setPhysicalBcCoefObject(
                            ...
                            boost::shared_ptr<SAMRAI::hier::Variable>(NULL));
  ...
  private:
    ...
    computeDiagonalEntries(
                           ...
                           const SAMRAI::pdat::SideData<double>& variable_off_diagonal,
     ...
     */
    boost::shared_ptr<SAMRAI::hier::CoarseFineBoundary> d_cf_boundary;
    ...
    boost::shared_ptr<SAMRAI::hier::Variable> d_physical_bc_variable;
    ...
    boost::shared_ptr<SAMRAI::hier::Variable> d_coarsefine_bc_variable;

    //@}

    /*!
     * @brief SAMRAI::hier::Patch index of A*k0(a) quantity
     *
     ...
     */
    boost::shared_ptr<SAMRAI::tbox::Timer> t_solve_system;
    boost::shared_ptr<SAMRAI::tbox::Timer> t_set_matrix_coefficients;
