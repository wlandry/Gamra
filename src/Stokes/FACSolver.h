...
namespace Stokes {
   ...
   * -# Construct a Stokes::FACSolver object, providing it
  ...
  public:
     ...
     * @param database SAMRAI::tbox::Database for initialization (may be NULL)
     */
    FACSolver(
     ...
     *
     * @param solution SAMRAI::hier::Patch data index for solution u
     * @param rhs SAMRAI::hier::Patch data index for right hand side f
     ...
     */
    void
    setBcObject(const SAMRAI::solv::RobinBcCoefStrategy* bc_object);
